...
import static xyz.sillyjune.biologica.block.BiologicaBlocks.BLOCKS;
...
public class BiologicaWoodType {
    public BiologicaWoodType(String id) {
        RegistrySupplier<Block> LOG = BLOCKS.register(id+"_log", BiologicaWoodType::newLog);
        RegistrySupplier<Item> LOG_ITEM = ITEMS.register(id+"_log", () -> new BlockItem(LOG.get(), new Item.Properties().arch$tab(BLOCKS_TAB)));
        RegistrySupplier<Block> STRIPPED_LOG = BLOCKS.register(id+"_log_stripped", BiologicaWoodType::newLog);
